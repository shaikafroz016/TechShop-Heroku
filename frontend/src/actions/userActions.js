...
export const logout = () => async(dispatch) => {
    ...
    //below code used to clear userlist if we logout as admin,  but for me it is directly redirecting me to the login page after logout
...
export const register = (name, email, password) => async(dispatch) => {
    try {
        ...
        //including this to directly login after registering
        dispatch({
            type: USER_LOGIN_SUCCESS,
            payload: data
        })
...
// User Profile get and update actions
